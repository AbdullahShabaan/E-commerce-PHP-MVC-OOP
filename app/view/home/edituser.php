                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" method ="post" 
                                   ...
                                   action='PostEditUser/<?=$_SESSION["id"]?>'
                         ...
                         foreach ($data as $d) {
                           echo $d["password"];
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name = "e_mail"  placeholder="enter a valid e-mail"
                                                class="form-control p-0 border-0" 
                                                   value="<?php
                        foreach ($data as $d) {
                           echo $d["e_mail"];
                                            ...
                                            <input type="hidden" name = "oldimg" value="<?php
                                                            foreach ($data as $d) {
                                                                echo $d['img'];
                                                                                        ...
                                                                                        ?>" >
                                                      <img src="<?=CSS_PATH.'back/plugins/images/'.$d['img']?>" width="200px" height="200px">
